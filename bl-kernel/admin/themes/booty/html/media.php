...
<div class="row">
	...
	<!--
		UPLOAD INPUT
	-->
		<h3 class="mt-2 mb-3"><i class="bi bi-images"></i> <?php $L->p('Images'); ?></h3>
		...
		$.each(files, function(key, filename) {
			...
			tableRow = '<tr id="js'+filename+'">'+
					...
					'<td class="information">'+
						...
						'<div>'+
							'<a href="#" class="mr-3 text-primary" onClick="editorInsertMedia(\''+image+'\'); closeMediaManager();"><i class="bi bi-plus-circle-fill"></i><?php $L->p('Insert') ?><\/a>'+
							'<a href="#" class="mr-3 text-primary" onClick="editorInsertMedia(\''+thumbnail+'\'); closeMediaManager();"><i class="bi bi-images"></i><?php $L->p('Insert thumbnail') ?><\/a>'+
