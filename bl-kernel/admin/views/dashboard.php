        ...
        <div class="col-md-7">
            ...
            <div>
                <h2 id="hello-message" class="pt-0">
                    ...
                    ?>
                    <span class="bi bi-hand-index-thumb"></span><span><?php echo $L->g('welcome') ?></span>
                </h2>
                <script>
                    $(document).ready(function() {
                        $("#hello-message").fadeOut(2400, function() {
                            ...
                            if (hours >= 6 && hours < 12) {
                                ...
                                $(this).html('<span class="bi bi-moon-stars"></span><?php echo $L->g('good-evening') . ', ' . $name ?>');
                            } else {
                                $(this).html('<span class="bi bi-moon-stars"></span><span><?php echo $L->g('good-night') . ', ' . $name ?></span>');
                            }
                        }).fadeIn(1000);
                    });
                </script>
                        ...
                        var clippy = $("#jsclippy").select2({
                            ...
                            templateResult: function(data) {
                                ...
                                if (data.type == 'menu') {
                                    ...
                                    html += '<i class="bi bi-' + data.icon + '"></i> ' + data.text + '</div></a>';
                                } else {
