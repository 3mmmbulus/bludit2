		...
		foreach ($list as $pageKey) {
			try {
				...
				if (!$page->isChild()) {
					...
					echo '<a class="text-secondary d-none d-md-inline ml-2" href="'.HTML_PATH_ADMIN_ROOT.'edit-content/'.$page->key().'"><i class="bi bi-pencil-square"></i>'.$L->g('Edit').'</a>'.PHP_EOL;
					if (count($page->children())==0) {
						echo '<a href="#" class="ml-2 text-danger deletePageButton d-block d-sm-inline" data-toggle="modal" data-target="#jsdeletePageModal" data-key="'.$page->key().'"><i class="bi bi-trash"></i>'.$L->g('Delete').'</a>'.PHP_EOL;
					}
					echo '</td>';
					...
					foreach ($page->children() as $child) {
						...
						echo '<a class="text-secondary d-none d-md-inline ml-2" href="'.HTML_PATH_ADMIN_ROOT.'edit-content/'.$child->key().'"><i class="bi bi-pencil-square"></i>'.$L->g('Edit').'</a>'.PHP_EOL;
						echo '<a class="ml-2 text-danger deletePageButton d-block d-sm-inline" href="#" data-toggle="modal" data-target="#jsdeletePageModal" data-key="'.$child->key().'"><i class="bi bi-trash"></i>'.$L->g('Delete').'</a>'.PHP_EOL;
						echo '</td>';
